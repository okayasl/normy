...
define_languages! {
    ...
    SPA, "SPA", "Spanish",
        ...
        strip: [ 'Á' => 'A', 'á' => 'a', 'É' => 'E', 'é' => 'e', 'Í' => 'I', 'í' => 'i', 'Ó' => 'O', 'ó' => 'o', 'Ú' => 'U', 'ú' => 'u', 'Ü' => 'U', 'ü' => 'u', 'Ñ' => 'N', 'ñ' => 'n' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    RON, "RON", "Romanian",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Ă' => 'A', 'ă' => 'a', 'Â' => 'A', 'â' => 'a', 'Î' => 'I', 'î' => 'i', 'Ș' => 'S', 'ș' => 's', 'Ț' => 'T', 'ț' => 't' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    HUN, "HUN", "Hungarian",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Á' => 'A', 'á' => 'a', 'É' => 'E', 'é' => 'e', 'Í' => 'I', 'í' => 'i', 'Ó' => 'O', 'ó' => 'o', 'Ö' => 'O', 'ö' => 'o', 'Ő' => 'O', 'ő' => 'o', 'Ú' => 'U', 'ú' => 'u', 'Ü' => 'U', 'ü' => 'u', 'Ű' => 'U', 'ű' => 'u' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    UKR, "UKR", "Ukrainian",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Ґ' => 'G', 'ґ' => 'g', 'Є' => 'E', 'є' => 'e', 'І' => 'I', 'і' => 'i', 'Ї' => 'I', 'ї' => 'i' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    BUL, "BUL", "Bulgarian",
        case: [ 'Щ' => 'щ', 'Ю' => 'ю', 'Я' => 'я' ],
        fold: [],
        transliterate: [ 'Щ' => "sht", 'щ' => "sht", 'Ю' => "yu", 'ю' => "yu", 'Я' => "ya", 'я' => "ya" ],
        strip: [],
        diac: [],
        segment: false,
        peek_ahead: false,
    ...
    LIT, "LIT", "Lithuanian",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Ą' => 'A', 'ą' => 'a', 'Č' => 'C', 'č' => 'c', 'Ė' => 'E', 'ė' => 'e', 'Ę' => 'E', 'ę' => 'e', 'Į' => 'I', 'į' => 'i', 'Š' => 'S', 'š' => 's', 'Ų' => 'U', 'ų' => 'u', 'Ū' => 'U', 'ū' => 'u', 'Ž' => 'Z', 'ž' => 'z' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    LAV, "LAV", "Latvian",
        case: [ 'Ā' => 'ā', 'Ē' => 'ē', 'Ī' => 'ī', 'Ū' => 'ū' ],
        fold: [],
        transliterate: [],
        strip: [ 'Ā' => 'A', 'ā' => 'a', 'Č' => 'C', 'č' => 'c', 'Ē' => 'E', 'ē' => 'e', 'Ģ' => 'G', 'ģ' => 'g', 'Ī' => 'I', 'ī' => 'i', 'Ķ' => 'K', 'ķ' => 'k', 'Ļ' => 'L', 'ļ' => 'l', 'Ņ' => 'N', 'ņ' => 'n', 'Š' => 'S', 'š' => 's', 'Ū' => 'U', 'ū' => 'u', 'Ž' => 'Z', 'ž' => 'z' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    EST, "EST", "Estonian",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Š' => 'S', 'š' => 's', 'Ž' => 'Z', 'ž' => 'z', 'Õ' => 'O', 'õ' => 'o', 'Ä' => 'A', 'ä' => 'a', 'Ö' => 'O', 'ö' => 'o', 'Ü' => 'U', 'ü' => 'u' ],
        diac: [],
        segment: false,
        peek_ahead: false,
        peek_pairs: [],
    ...
    ELL, "ELL", "Greek",
        ...
        fold: [],
        transliterate: [],
        strip: [ 'Ά' => 'Α', 'ά' => 'α', 'Έ' => 'Ε', 'έ' => 'ε', 'Ή' => 'Η', 'ή' => 'η', 'Ί' => 'Ι', 'ί' => 'ι', 'Ό' => 'Ο', 'ό' => 'ο', 'Ύ' => 'Υ', 'ύ' => 'υ', 'Ώ' => 'Ω', 'ώ' => 'ω', 'Ϊ' => 'Ι', 'ϊ' => 'ι', 'Ϋ' => 'Υ', 'ϋ' => 'υ', 'ΐ' => 'ι', 'ΰ' => 'υ' ],
